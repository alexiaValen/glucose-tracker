...
//     marginBottom: "26px",
//     // Single, cohesive hero surface (no box-in-box)
//     background:
...
//         <div style={styles.identityGrain} />
//         <div style={styles.identityContent}>
//           <div style={styles.identityTitle}>Welcome back, {firstName}</div>
//           <div style={styles.identitySubtext}>Strength grows quietly before it shows.</div>
//           <div style={styles.identityDivider} />
//           <div style={styles.identityWhisper}>You are entering a guided ecosystem for transformation.</div>
//         </div>
//       </section>
