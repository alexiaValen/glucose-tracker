...
export default function DashboardScreen({ navigation }: Props) {
  ...
  const [cycleProfile, setCycleProfile] = useState<any>('regular');
  ...
  const profile = await AsyncStorage.getItem('cycleProfile');
  if (profile) setCycleProfile(profile);
};
...
const styles = StyleSheet.create({
  ...
  greetingLight: { fontSize: 13, color: 'rgba(42,45,42,0.6)', fontWeight: '400', letterSpacing: 0.3 },
  greetingBold: { fontSize: 24, fontWeight: '700', color: '#2B2B2B', letterSpacing: -0.5 },
  ...
  primaryButton: {
    flex: 1, backgroundColor: '#6B7F6E', paddingVertical: 18, borderRadius: 16,
  ...
  secondaryButton: {
    flex: 1, backgroundColor: 'rgba(255,255,255,0.95)', paddingVertical: 18, borderRadius: 16,
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    borderWidth: 1, borderColor: 'rgba(212,214,212,0.3)',
    shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 2,
  },
  secondaryButtonText: { color: '#2B2B2B', fontSize: 15, fontWeight: '600', letterSpacing: 0.3 },
  coachChatCard: {
    backgroundColor: 'rgba(255,255,255,0.95)', borderRadius: 20, padding: 16, marginBottom: 16,
  ...
  coachChatAvatar: {
    ...
    backgroundColor: 'rgba(107,127,110,0.15)', alignItems: 'center', justifyContent: 'center', marginRight: 14,
  },
  coachChatAvatarText: { fontSize: 18, fontWeight: '700', color: '#6B7F6E' },
  coachChatContent: { flex: 1 },
  coachChatLabel: { fontSize: 10, fontWeight: '600', color: 'rgba(107,127,110,0.7)', letterSpacing: 0.8, marginBottom: 3 },
  coachChatName: { fontSize: 15, fontWeight: '600', color: '#2B2B2B' },
  coachChatAction: { paddingLeft: 8 },
  coachChatArrow: { fontSize: 20 },
  joinGroupButton: {
  ...
  joinGroupIcon: {
    ...
    backgroundColor: 'rgba(107,127,110,0.1)', alignItems: 'center', justifyContent: 'center', marginRight: 16,
  },
  ...
  enrolledBadge: {
    alignSelf: 'flex-start', backgroundColor: 'rgba(107,127,110,0.15)',
    paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12, marginBottom: 12,
  },
  enrolledBadgeText: { fontSize: 10, fontWeight: '700', color: '#6B7F6E', letterSpacing: 0.8 },
  enrolledTitle: { fontSize: 18, fontWeight: '600', color: '#2B2B2B', marginBottom: 6 },
  enrolledSubtitle: { fontSize: 13, color: 'rgba(42,45,42,0.6)' },
  sessionQuickAccess: { gap: 8 },
  sessionQuickLabel: { fontSize: 10, fontWeight: '600', color: 'rgba(107,127,110,0.7)', letterSpacing: 0.8, paddingHorizontal: 4 },
  sessionQuickCard: {
  ...
  sessionQuickIcon: {
    width: 40, height: 40, borderRadius: 20,
    backgroundColor: 'rgba(107,127,110,0.1)', alignItems: 'center', justifyContent: 'center', marginRight: 12,
  },
  sessionQuickIconText: { fontSize: 20 },
  sessionQuickInfo: { flex: 1 },
  sessionQuickNumber: { fontSize: 10, fontWeight: '600', color: 'rgba(107,127,110,0.7)', letterSpacing: 0.8, marginBottom: 3 },
  sessionQuickTitle: { fontSize: 14, fontWeight: '600', color: '#2B2B2B' },
  sessionQuickArrow: { fontSize: 18, color: '#6B7F6E' },
  card: {
    backgroundColor: 'rgba(255,255,255,0.95)', borderRadius: 20, padding: 20, marginBottom: 16,
    borderWidth: 1, borderColor: 'rgba(212,214,212,0.25)',
    shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 2,
  ...
  sectionHeader: { fontSize: 11, fontWeight: '700', color: 'rgba(107,127,110,0.7)', letterSpacing: 1 },
  glucoseReading: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  displayLarge: { fontSize: 48, fontWeight: '700', color: '#2B2B2B', letterSpacing: -1 },
  unitText: { fontSize: 16, fontWeight: '400', color: 'rgba(42,45,42,0.5)' },
  glucoseSubtext: { fontSize: 13, color: 'rgba(42,45,42,0.6)', marginTop: 4 },
  statusBadge: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: 'rgba(107,127,110,0.1)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12, gap: 6,
  },
  statusDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#6B7F6E' },
  statusText: { fontSize: 11, fontWeight: '600', color: '#6B7F6E', letterSpacing: 0.5 },
  ...
  statValue: { fontSize: 24, fontWeight: '700', color: '#2B2B2B', marginBottom: 4 },
  statLabel: { fontSize: 11, color: 'rgba(42,45,42,0.6)', textTransform: 'capitalize' },
  recentReading: {
    flexDirection: 'row', alignItems: 'center', gap: 8,
    paddingTop: 12, borderTopWidth: 1, borderTopColor: 'rgba(212,214,212,0.3)',
  },
  recentDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#6B7F6E' },
  recentText: { fontSize: 13, color: '#2B2B2B', flex: 1 },
  recentTime: { fontSize: 12, color: 'rgba(42,45,42,0.5)' },
  cyclePhaseGlyph: { opacity: 0.3 },
  cycleContent: { alignItems: 'center' },
  cycleDay: { fontSize: 32, fontWeight: '700', color: '#2B2B2B', marginBottom: 16 },
  cycleProgressBar: {
    width: '100%', height: 6, backgroundColor: 'rgba(212,214,212,0.3)',
    borderRadius: 3, overflow: 'hidden', marginBottom: 12,
  },
  cycleProgressFill: { height: '100%', backgroundColor: '#6B7F6E', borderRadius: 3 },
  cyclePhase: { fontSize: 14, fontWeight: '500', color: 'rgba(42,45,42,0.7)' },
  emptyStateButton: { paddingVertical: 12, alignItems: 'center' },
  emptyStateText: { fontSize: 14, fontWeight: '500', color: '#6B7F6E' },
  symptomItem: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
    paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: 'rgba(212,214,212,0.3)',
  },
  symptomLeft: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  severityTick: { width: 4, height: 20, borderRadius: 2 },
  symptomName: { fontSize: 15, fontWeight: '500', color: '#2B2B2B', textTransform: 'capitalize' },
  symptomRight: { alignItems: 'flex-end' },
  symptomSeverity: { fontSize: 13, fontWeight: '600', color: 'rgba(42,45,42,0.6)' },
  seeAllLink: { fontSize: 13, fontWeight: '500', color: '#6B7F6E' },
});